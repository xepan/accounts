...
class Initiator extends \Controller_Addon {
	...
	function populateConfigurationMenus(){
        ...
        $m->addItem(['Currencies Management','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_currency'));
        $m->addItem(['Default Currency','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_config_currency'));
        $m->addItem(['Accounts Entry Templates','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_custom_accountentries'));
        $m->addItem(['Financial Year Starting Month','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_financialyear'));
        $m->addItem(['HR Employee Salary Ledger Association','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_salaryledgerassociation'));
        // $m->addItem(['Accounts Auto Notifications','icon'=>'fa fa-cog'],$this->app->url('xepan_accounts_autonotification'));
	}
    ...
    function exportEntities($app,&$array){
        ...
        $array['Accounts_Group'] = ['caption'=>'Accounts_Group', 'type'=>'xepan\base\DropDown','model'=>'xepan\accounts\Model_Group'];
    }
