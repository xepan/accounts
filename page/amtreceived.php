...
class page_amtreceived extends \Page {
	...
	function init(){
		...
		/*Invoices*/
		$invoice_1_field = $form->addField('Dropdown','invoice_no_1')->validateNotNull(true);
		$invoice_1_field->setModel('xepan\commerce\SalesInvoice');
		$invoice_1_amount = $form->addField('line','invoice_amount_1')->validateNotNull(true);
		$invoice_1_adjust = $form->addField('checkbox','invoice_adjust_1')->set(true);
		$invoice_1_currency = $form->addField('Dropdown','invoice_currency_1')->validateNotNull(true);
		$invoice_1_currency->setModel('xepan\accounts\Currency');
		$invoice_1_exchange_rate = $form->addField('line','invoice_exchange_rate_1');

		$invoice_2_field = $form->addField('Dropdown','invoice_no_2')->validateNotNull(true);
		$invoice_2_field->setModel('xepan\commerce\SalesInvoice');
		$invoice_2_amount = $form->addField('line','invoice_amount_2')->validateNotNull(true);
		$invoice_2_adjust = $form->addField('checkbox','invoice_adjust_2')->set(true);
		$invoice_2_currency = $form->addField('Dropdown','invoice_currency_2')->validateNotNull(true);
		$invoice_2_currency->setModel('xepan\accounts\Currency');
		$invoice_2_exchange_rate = $form->addField('line','invoice_exchange_rate_2');

		$invoice_3_field = $form->addField('Dropdown','invoice_no_3')->validateNotNull(true);
		$invoice_3_field->setModel('xepan\commerce\SalesInvoice');
		$invoice_3_amount = $form->addField('line','invoice_amount_3')->validateNotNull(true);
		$invoice_3_adjust = $form->addField('checkbox','invoice_adjust_3')->set(true);
		$invoice_3_currency = $form->addField('Dropdown','invoice_currency_3')->validateNotNull(true);
		$invoice_3_currency->setModel('xepan\accounts\Currency');
		$invoice_3_exchange_rate = $form->addField('line','invoice_exchange_rate_3');

		$invoice_4_field = $form->addField('Dropdown','invoice_no_4')->validateNotNull(true);
		$invoice_4_field->setModel('xepan\commerce\SalesInvoice');
		$invoice_4_amount = $form->addField('line','invoice_amount_4')->validateNotNull(true);
		$invoice_4_adjust = $form->addField('checkbox','invoice_adjust_4')->set(true);
		$invoice_4_currency = $form->addField('Dropdown','invoice_currency_4')->validateNotNull(true);
		$invoice_4_currency->setModel('xepan\accounts\Currency');
		$invoice_4_exchange_rate = $form->addField('line','invoice_exchange_rate_4');

		$invoice_5_field = $form->addField('Dropdown','invoice_no_5')->validateNotNull(true);
		$invoice_5_field->setModel('xepan\commerce\SalesInvoice');
		$invoice_5_amount = $form->addField('line','invoice_amount_5')->validateNotNull(true);
		$invoice_5_adjust = $form->addField('checkbox','invoice_adjust_5')->set(true);
		$invoice_5_currency = $form->addField('Dropdown','invoice_currency_5')->validateNotNull(true);
		$invoice_5_currency->setModel('xepan\accounts\Currency');
		$invoice_5_exchange_rate = $form->addField('line','invoice_exchange_rate_5');
		...
		if($form->isSubmitted()){
			...
			//2//
				//Dr in Default Bank Account with 
