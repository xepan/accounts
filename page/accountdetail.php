...
class page_accountdetail extends \xepan\base\Page{
  ...
  //       $this->add('xepan\accounts\Model_Ledger')->loadDefaults();
	...
	$data =[
			...
			'FixedAssets' => ['name'=>'Furniture', 'description'=>'Entries related to Assets','group_id'=>$this->add('xepan\accounts\Model_Group')->load("Fixed Assets")->get('id'),'ledger_type'=>'FixedAssets']
		];
